        ...
        <Tabs.Content value="tree" flex="1" p="0" minH="0" display="flex" flexDirection="column">
          <HStack justify="space-between" px="3" py="2" borderBottomWidth="1px" borderColor="gray.850" flexWrap="nowrap" gap="2">
            <HStack gap="1.5" minW="0">
              ...
              <Text fontSize="xs" fontWeight="bold" color="blue.300" textTransform="uppercase" lineClamp={1} whiteSpace="nowrap">
                Ontology Tree
              </Text>
            </HStack>
                        ...
                        return isBranch ? (
                          ...
                          >
                            ...
                            <Box flex="1" minW="0">
                              ...
                              {node.definition && (
                                <Text fontSize="xs" color="gray.400" fontStyle="italic" lineClamp={2} mt="0.5">
                                  "{node.definition}"
                                </Text>
                              )}
                            </Box>
            ...
            <VStack align="stretch" gap="3">
              ...
              {simResult && (
                <Box p="3" bg="gray.850" borderRadius="lg" borderWidth="1px" borderColor="purple.700">
                  <Stat.Root>
                    <Stat.Label fontSize="xs" color="gray.400">{simResult.metric} Metric</Stat.Label>
                    ...
                    <Text fontSize="xs" color="gray.450" mt="1.5">
