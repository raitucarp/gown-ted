...
import { WordSenseItem } from "./WordSensesPanel";
...
import {
  ...
  PragmaticsInfo,
  DiscourseInfo,
} from "../../../bindings/github.com/raitucarp/gown-ted/models";
              ...
              <Box>
                <HStack justifyContent="space-between" mb="2.5" flexWrap="wrap" gap="2">
                  ...
                  <HStack gap="2.5" alignItems="center">
                    ...
                    {activeSense.ili && (
                      <HStack gap="1" color="gray.450" fontSize="2xs">
                ...
                {/* Definition text */}
                <Box mb="3" p="3" bg="gray.850" borderRadius="lg" borderWidth="1px" borderColor="gray.800">
                ...
                {activeSense.examples && activeSense.examples.length > 0 && (
                  <Box mb="3">
                    <Text fontSize="2xs" fontWeight="bold" color="teal.300" textTransform="uppercase" mb="1.5">
                      Usage Examples
                    </Text>
                    <VStack align="stretch" gap="1.5">
                      {activeSense.examples.map((ex, idx) => (
                        ...
                        >
                          <LuQuote size={13} color="#4FD1C5" style={{ flexShrink: 0, marginTop: "2px" }} />
                ...
                {sentenceContext && sentenceContext !== word && (
                  <Box p="2.5" bg="gray.850" borderRadius="md" borderWidth="1px" borderColor="gray.800">
                    <HStack gap="1" mb="1">
                      ...
                      <Text fontSize="2xs" fontWeight="bold" color="blue.300" textTransform="uppercase">
                        Active Sentence Context
                      </Text>
                    </HStack>
            ...
            {functional && (functional.themeRheme.theme || functional.themeRheme.rheme) ? (
              <VStack align="stretch" gap="3.5">
                  ...
                  <HStack align="stretch" gap="3">
                    ...
                    >
                      <HStack justify="space-between" mb="1.5">
                        ...
                        <Text fontSize="2xs" color="teal.300">
                          Point of Departure
                        </Text>
                      </HStack>
                    ...
                    >
                      <HStack justify="space-between" mb="1.5">
                        ...
                        <Text fontSize="2xs" color="blue.300">
                ...
                <Box p="3" bg="gray.850" borderRadius="lg" borderWidth="1px" borderColor="gray.800">
                  ...
                  <HStack flexWrap="wrap" gap="4">
                    ...
                    {functional.interpersonal.modality && (
                      <Box>
                        <Text fontSize="2xs" color="gray.400">Modality Stance</Text>
                ...
                {functional.cohesiveTies && functional.cohesiveTies.length > 0 && (
                  <Box>
                    <Text fontSize="2xs" fontWeight="bold" color="cyan.300" textTransform="uppercase" mb="1.5">
          ...
          <PanelScrollArea p="3.5">
            {pragmatics && (pragmatics.speechAct.class || pragmatics.politeness.strategy) ? (
              <VStack align="stretch" gap="3.5">
                ...
                <Box p="3" bg="gray.850" borderRadius="lg" borderWidth="1px" borderColor="gray.800">
                  <Stat.Root>
                    <Stat.Label fontSize="2xs" color="gray.400">Illocutionary Force & Speech Act Class</Stat.Label>
                ...
                <Box p="3" bg="gray.850" borderRadius="lg" borderWidth="1px" borderColor="gray.800">
                  <HStack justify="space-between" mb="2">
                    <Box>
                      <Text fontSize="2xs" fontWeight="bold" color="teal.300" textTransform="uppercase">
                    ...
                    <Box textAlign="right">
                      <Text fontSize="2xs" color="gray.400">Hedge / Mitigation Score</Text>
                  ...
                  {pragmatics.politeness.mitigation_tags && pragmatics.politeness.mitigation_tags.length > 0 && (
                    <Box mt="2">
                      <Text fontSize="2xs" color="gray.400" mb="1">Mitigation Elements Detected:</Text>
          ...
          <PanelScrollArea p="3.5">
            {discourse && discourse.thematicProgression && discourse.thematicProgression.length > 0 ? (
              <VStack align="stretch" gap="3">
                <Text fontSize="2xs" fontWeight="bold" color="orange.300" textTransform="uppercase">
